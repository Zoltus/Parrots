...
abstract class APICommand extends Command {
    ...
    private final ArrayList<APICommand> subCommands = new ArrayList<>();
    ...
    public void addAlias(String alias) {
        getAliases().add(alias.toLowerCase());
    }

    @Override
    public boolean execute(@NonNull CommandSender sender, @NonNull String commandLabel, @Nullable String[] args) {
    ...
    @Override
    @NonNull
    public List<String> tabComplete(@NonNull CommandSender sender, @NonNull String alias, @Nullable String[] args) {
